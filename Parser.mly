...
type : T_integer | T_real | T_boolean | T_char |
       T_array array_length_opt T_of type | T_exp type
...
(* Unary Operators *)
unop : T_not | T_plus | T_minus { () }

(* Binary Operators *)
binop : T_plus | T_minus | T_times | T_frac | T_div | T_mod
        | T_or | T_and | T_neq | T_eq | T_lt | T_gt | T_lte | T_gte { () }
